...
//            log.log(Level.INFO, "Total Client time:" + totalTime);
    ...
    // creates additive shares of the search keyword value
     ...
     * @param args takes as string a column name and column value e.g. "linenumber,5"
     */
    ...
    /**
     * This program is used to search a key over a numeric type column. It can search one numeric value at a time.
     *
     * @param args takes as string a column name and column value e.g. "linenumber,5"
